...
public class HomeServiceImpl implements
    ...
    public String getMapUrl(String location) {
        return "https://maps.googleapis.com/maps/api/staticmap?center=" + location + "&zoom=10&size=1000x500&maptype=terrain&markers=color:blue%7C$location&key=AIzaSyA0ODy6qL436fn4u1NDD8rpj-RMMpIAqT8";
    }
