...
public interface ApplicationContext {
    ...
    static class PresentationModule {
        ...
        @Provides
        static PlanScreen planScreen(PlanPresenter presenter, Provider<CreatePlanWindow> planWindowProvider, Provider<CreatePlaceWindow> placeWindowProvider, Provider<PlanDetailsWindow> planDetailsWindow, Provider<EditProfileWindow> editProfileWindow) {
            return new PlanScreenImpl(presenter, planWindowProvider, placeWindowProvider, planDetailsWindow, editProfileWindow);
        }
        ...
        @Provides
        static ProfileScreen profileScreen(ProfilePresenter presenter, Provider<CreatePlanWindow> planWindowProvider, Provider<CreatePlaceWindow> placeWindowProvider, Provider<EditProfileWindow> editProfileWindowProvider, Provider<PlanDetailsWindow> planDetailsWindowProvider) {
            return new ProfileScreenImpl(presenter, planWindowProvider, placeWindowProvider, editProfileWindowProvider, planDetailsWindowProvider);
        }
